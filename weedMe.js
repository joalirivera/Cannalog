// class FoodItem {
// 	constructor (name, strainType, qualities, consumeTime, thc) {
// 		this.name 	 	 = name;
...
// 	}
// 	myString (){
// 		console.log(this.name, this.strainType, this.qualities, this.consumeTime, this.thc);
// 	}
// }
...
// this.strainFound  = False;
// this.strainIndex  = -1;
// this.searchStrain = function(name) {
//     this.strainFound= false;
// }
// for(car=0; i < weedLibrary.length; i++) {
//     if(weedLibrary[i].name == name) {
//         this.name = weedLibrary[i].name;
//         this.strainType = weedLibrary[i].strainType;
//         this.strainType = weedLibrary[i].strainType;
//         this.qualities  = weedLibrary[i].qualities;
//         this.thc        = weedLibrary[i].thc;
//     }
// }
